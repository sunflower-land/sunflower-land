...
import { service, Context, BlockchainEvent, BlockchainState, OnboardingStates } from '../../machine'
...
const steps: ReactourStep[] = [
  ...
  },
  {
    ...
    content: ({ goTo }) => (
      <div>
        You recieved $0.02 Sunflower Farmer Tokens for the harvest
  ...
  },
  {
    ...
    content: () => (
        <div>
          You can buy different types of seeds here. Some are more expensive but yield greater rewards
...
export const Tour: React.FC = () => {
    ...
    const step =  STEP_MACHINE[(machineState.value as any).onboarding as OnboardingStates] || 0

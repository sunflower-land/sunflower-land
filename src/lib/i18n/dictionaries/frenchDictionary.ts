...
const generalTerms: Record<GeneralTerms, string> = {
  ...
  plant: "Planter",
  "player.farm.iD": "ID de la Ferme du Joueur",
...
const boostDescriptions: Record<BoostDescriptions, string> = {
  ...
  "description.fat.chicken.two":
    "10% de moins de blé nécessaire pour nourrir une poule",
  ...
  // Boosts
  "description.lab.grow.pumpkin": "+0,3 de rendement en citrouilles",
  "description.lab.grown.radish": "+0,4 de rendement en radis",
  ...
  "description.obie": "Un vaillant soldat aubergine",
  ...
  "description.Karkinos":
    "Pincé mais gentil, l'ajout crabe-chou à votre ferme qui améliore la production de choux !",
  ...
  "description.kernaldo.1":
    "Le chuchoteur de maïs magique. +25% de vitesse de croissance du maïs.",
  "description.poppy": "Le noyau de maïs mystique.",
  "description.poppy.1": "Le noyau de maïs mystique. +0,1 de maïs par récolte,",
  "description.victoria.sisters": "Les sœurs amatrices de citrouilles",
  ...
  "description.peeled.potato":
    "Une précieuse pomme de terre, encourage les pommes de terre bonus à la récolte.",
  "description.potent.potato":
    "Puissant ! Donne une chance de 3% d'obtenir +10 pommes de terre à la récolte.",
  "description.radical.radish":
    "Radical ! Donne une chance de 3% d'obtenir +10 radis à la récolte.",
  "description.stellar.sunflower":
    "Stellaire ! Donne une chance de 3% d'obtenir +10 tournesols à la récolte.",
  ...
  "description.tiki.totem":
    "Le Totem Tiki ajoute 0,1 de bois à chaque arbre que vous coupez.",
  ...
  "description.freya.fox":
    "Gardienne enchanteresse, stimule la croissance des citrouilles avec son charme mystique. Récoltez des citrouilles abondantes sous son regard vigilant.",
  "description.queen.cornelia":
    "Commandez le pouvoir royal de la Reine Cornelia et bénéficiez d'un magnifique boost de zone d'effet pour votre production de maïs. +1 de maïs.",
};
...
const boostEffectDescriptions: Record<BoostEffectDescriptions, string> = {
  ...
  "description.purple.trail.boost": "+0.2 Aubergine",
  "description.freya.fox.boost": "+0.5 Citrouille",
  "description.sir.goldensnout.boost": "+0.5 Récolte (AOE 4x4)",
  "description.maximus.boost": "+1 Aubergine",
  "description.basic.scarecrow.boost":
    "-20% Temps de croissance des cultures de base : Tournesol, Pomme de terre et Citrouille (AOE 3x3)",
  "description.scary.mike.boost":
    "+0.2 Culture moyenne : Carotte, Chou, Betterave, Chou-fleur et Panais (AOE 3x3)",
  ...
  "description.nana.boost": "-10% Temps de croissance de la banane",
  ...
  "description.emerald.turtle.boost": "+0.5 Pierre, Fer, Or (AOE 3x3)",
  "description.tin.turtle.boost": "+0.1 Pierre (AOE 3x3)",
  "description.heart.of.davy.jones.boost": "+20 Limite de creusage quotidienne",
  "description.Karkinos.boost": "+0.1 Chou (Inactif avec Cabbage Boy)",
  ...
  "description.peeled.potato.boost": "20% Chance d'obtenir +1 Pomme de terre",
  "description.victoria.sisters.boost": "+20% Citrouille",
  "description.easter.bunny.boost": "+20% Carotte",
  "description.pablo.bunny.boost": "+0.1 Carotte",
  "description.cabbage.boy.boost": "+0.25 Chou (+0.5 avec Cabbage Girl)",
  "description.cabbage.girl.boost": "-50% Temps de croissance du chou",
  "description.golden.cauliflower.boost": "+100% Chou-fleur",
  "description.mysterious.parsnip.boost": "-50% Temps de croissance du panais",
  "description.queen.cornelia.boost": "+1 Maïs (AOE 3x4)",
  "description.foliant.boost": "+0.2 Chou frisé",
  "description.hoot.boost": "+0.5 Blé, Radis, Chou frisé",
  ...
  "description.potent.potato.boost":
    "Chance de 3% d'obtenir +10 Pomme de terre",
  "description.radical.radish.boost": "Chance de 3% d'obtenir +10 Radis",
  "description.lg.pumpkin.boost": "+0.3 Citrouille",
  "description.lg.carrot.boost": "+0.2 Carotte",
  "description.lg.radish.boost": "+0.4 Radis",
  "description.fat.chicken.boost": "-0.1 Blé pour nourrir les poulets",
  ...
  "description.gold.egg.boost": "Nourrir les poulets sans blé",
  "description.woody.beaver.boost": "+20% Bois",
  "description.apprentice.beaver.boost":
    "+20% Bois ; -50% Temps de récupération des arbres",
  "description.foreman.beaver.boost":
    "+20% Bois ; -50% Temps de récupération des arbres ; Couper les arbres sans haches",
  "description.wood.nymph.wendy.boost": "+0.2 Bois",
  "description.tiki.totem.boost": "+0.1 Bois",
...
const buildingDescriptions: Record<BuildingDescriptions, string> = {
  ...
  "description.fire.pit":
    "Faites griller vos Tournesols, nourrissez et améliorez votre Bumpkin",
...
const bumpkinItemBuff: Record<BumpkinItemBuff, string> = {
  ...
  "bumpkinItemBuff.angel.wings.boost": "Récolte instantanée",
  "bumpkinItemBuff.devil.wings.boost": "Récolte instantanée",
  ...
  "bumpkinItemBuff.parsnip.boost": "+20 % de Panais",
...
const bumpkinSkillsDescription: Record<BumpkinSkillsDescription, string> = {
  ...
  "description.golden.flowers": "Chance d'obtenir des tournesols en or",
...
const choresStart: Record<ChoresStart, string> = {
  ...
  "chores.harvestFieldsIntro":
    "Ces champs ne se récolteront pas tout seuls. Récoltez 3 tournesols.",
  "chores.earnSflIntro":
    "Si vous voulez réussir dans le monde de l'agriculture, vous feriez mieux de commencer par vendre des tournesols, acheter des graines et récolter les bénéfices.",
...
const chumDetails: Record<ChumDetails, string> = {
  ...
  "chumDetails.potato":
    "Les pommes de terre font un festin aquatique inhabituel.",
  "chumDetails.pumpkin":
  ...
  "chumDetails.radish": "Les radis, le trésor enfoui des animaux aquatiques.",
  "chumDetails.wheat":
    "Le blé, un délice granuleux pour les fouilleurs sous-marins.",
  ...
  "chumDetails.wood": "Du bois. Un choix intéressant....",
};
...
const conversations: Record<Conversations, string> = {
  ...
  "betty-intro.three":
    "Tu as besoin de graines ? Des pommes de terre aux panais, j'ai ce qu'il te faut !",
  ...
  "betty.market-intro.four":
    "Récolte ces tournesols et commençons ton empire agricole.",
  ...
  "pete.craftScarecrow.three":
    "Dirige-toi vers l'établi et fabrique un épouvantail pour accélérer la croissance de ces tournesols.",
  ...
  "pete.intro.one":
    "Salut là-bas, Bumpkin ! Bienvenue à Sunflower Land, le paradis de l'agriculture où tout est possible !",
  "pete.intro.two":
    "Quelle belle île tu as mise en place ! Je suis Pumpkin Pete, ton voisin fermier.",
  "pete.intro.three":
...
const cropFruitDescriptions: Record<CropFruitDescriptions, string> = {
  ...
  "description.warty.goblin.pumpkin":
    "Une citrouille fantaisiste et verruqueuse",
...
const decorationDescriptions: Record<DecorationDescriptions, string> = {
  ...
  "description.sunflower.amulet":
    "Augmentation de 10 % du rendement en tournesols.",
  ...
  "description.potato.statue":
    "Le OG de la pomme de terre qui en a dans le ventre.",
  ...
  "description.sunflower.tombstone":
    "En mémoire des agriculteurs de tournesols.",
  ...
  "description.chicken":
    "Produit des œufs. Nécessite du blé pour la nourriture.",
  "description.cow": "Produit du lait. Nécessite du blé pour la nourriture.",
  ...
  "description.tree":
    "Un arbre que vous pouvez abattre pour collecter du bois.",
  ...
  "description.solar.lantern":
    "Utilisant l'essence vibrante des tournesols, la lanterne solaire émet une lueur chaude et radieuse.",
  ...
  "description.dawn.umbrella":
    "Gardez ces aubergines au sec lors des journées pluvieuses avec le siège-parapluie Dawn.",
  "description.eggplant.grill":
    "Préparez vos repas en plein air avec le gril à aubergines, parfait pour tout repas en plein air.",
  ...
  "description.eggplant.bear": "La marque d'une baleine aubergine généreuse.",
  ...
  // Flowers
  "description.red.pansy": "Une pensée rouge.",
  "description.yellow.pansy": "Une pensée jaune.",
  "description.purple.pansy": "Une pensée violette.",
  "description.white.pansy": "Une pensée blanche.",
  "description.blue.pansy": "Une pensée bleue.",

  "description.red.cosmos": "Un cosmos rouge.",
  "description.yellow.cosmos": "Un cosmos jaune.",
  "description.purple.cosmos": "Un cosmos violet.",
  "description.white.cosmos": "Un cosmos blanc.",
  "description.blue.cosmos": "Un cosmos bleu.",

  "description.red.balloon.flower": "Une fleur ballon rouge.",
  "description.yellow.balloon.flower": "Une fleur ballon jaune.",
  "description.purple.balloon.flower": "Une fleur ballon violette.",
  "description.white.balloon.flower": "Une fleur ballon blanche.",
  "description.blue.balloon.flower": "Une fleur ballon bleue.",

  "description.red.carnation": "Une œillet rouge.",
  "description.yellow.carnation": "Une œillet jaune.",
  "description.purple.carnation": "Une œillet violet.",
  "description.white.carnation": "Une œillet blanc.",
  "description.blue.carnation": "Une œillet bleu.",
  ...
  "description.red.daffodil": "Une jonquille rouge.",
  "description.yellow.daffodil": "Une jonquille jaune.",
  "description.purple.daffodil": "Une jonquille violette.",
  "description.white.daffodil": "Une jonquille blanche.",
  "description.blue.daffodil": "Une jonquille bleue.",

  "description.red.lotus": "Un lotus rouge.",
  "description.yellow.lotus": "Un lotus jaune.",
  "description.purple.lotus": "Un lotus violet.",
  "description.white.lotus": "Un lotus blanc.",
  "description.blue.lotu": "Un lotus bleu.",
...
const fishDescriptions: Record<FishDescriptions, string> = {
  ...
  "description.whiteshark.two":
    "Plongez dans un océan de saveurs palpitantes !",
...
const flowerbreed: Record<Flowerbreed, string> = {
  ...
  "flower.breed.parsnip":
    "Un panais pourrait être un bon choix pour le croisement.",
  "flower.breed.eggplant":
    "L'aubergine a une couleur vibrante, peut-être qu'elle se croisera bien.",
  "flower.breed.radish": "Wow, ce radis est rouge !",
...
const foodDescriptions: Record<FoodDescriptions, string> = {
  ...
  "description.cabbers.mash": "Choux et purée de pommes de terre",
  "description.popcorn":
  ...
  "description.mushroom.jacket.potatoes":
    "Garnissez ces pommes de terre de tout ce que vous avez !",
  ...
  "description.purple.smoothie": "On ne sent presque pas le chou",
...
const guideTerms: Record<GuideTerms, string> = {
  ...
  "pete.teaser.three": "Récoltez les tournesols",
  "pete.teaser.four": "Vendez les tournesols",
...
const grubshop: Record<GrubShop, string> = {
  "message.grublinOrders":
    "Revenez demain pour consulter les commandes Grublin.",
  "message.orderFulfilled": "Commande accomplie",
  ...
  "message.earnSeasonalTickets":
    "Gagnez 10 billets saisonniers pour chaque repas.",
};
...
const henHouseTerms: Record<HenHouseTerms, string> = {
  ...
  "henHouse.text.one": "Nourrissez-les avec du blé et collectez des œufs",
...
const interactableModals: Record<InteractableModals, string> = {
  ...
  "interactableModals.plazaBlueBook.message1":
    "Pour invoquer les chercheurs, nous devons rassembler l'essence de la terre - les citrouilles, nourries par la terre, et les œufs, la promesse de nouveaux départs.",
  ...
  "interactableModals.dawnBook2.message1":
    "Les aubergines, elles sont plus qu'elles n'en ont l'air. Malgré leur extérieur sombre qui attire les créatures obscures, elles apportent de la lumière à nos plats.",
...
const islandName: Record<IslandName, string> = {
  "island.home": "Accueil",
  "island.pumpkin.plaza": "Place des Citrouilles",
  "island.beach": "Plage",
  "island.woodlands": "Bois",
...
const kick: Record<Kick, string> = {
  "kick.player": "Exclure un joueur",
  "kick.Message":
    "Veuillez noter que vous pouvez toujours revenir, mais si vous continuez à enfreindre les règles, nous prendrons des mesures supplémentaires.",
  "kick.Reason":
    "Raison de l'exclusion (Veuillez noter que le joueur verra ceci)",
  "kick.player.farm": "Exclure le joueur de la ferme",
  "kick.player.kick": "Le joueur a été exclu.",
  "kick.player.failed": "Impossible d'exclure le joueur",
  "kick.player.kicking": "Exclusion du joueur en cours...",
};
...
const levelUpMessages: Record<LevelUpMessages, string> = {
  ...
  "levelUp.14":
    "Niveau 14, c'est incroyable à quel point vous avez progressé !",
  "levelUp.15":
  ...
  "levelUp.33":
    "Niveau 33, vos compétences en agriculture décollent vraiment !",
...
const mute: Record<Mute, string> = {
  ...
  "mute.duration":
    "Durée de la mise en sourdine (Veuillez noter que le joueur verra ceci)",
  "mute.Reason":
    "Raison de la mise en sourdine (Veuillez noter que le joueur verra ceci)",
  "mute.player.farm": "Muter le joueur de la ferme ",
  "mute.player.mute": "Le joueur a été mis en sourdine ",
  "mute.fail": "Échec de la mise en sourdine du joueur",
  "mute.player.muting": "Mise en sourdine du joueur en cours...",
  "mute.you": "Vous avez été mis en sourdine !",
  "mute.until": "Vous êtes en sourdine jusqu'au",
  "mute.discord":
    "Si vous êtes en désaccord avec cette décision, veuillez nous contacter sur Discord.",
  "mute.unmute.farm": "Annuler la mise en sourdine du joueur de la ferme",
  "mute.unmute.player": "Le joueur a été rétabli",
  "mute.unmute.failed":
    "Échec de l'annulation de la mise en sourdine du joueur",
  "mute.unmuting.player":
    "Annulation de la mise en sourdine du joueur en cours...",
  "mute.online":
    "Si vous devez mettre en sourdine un joueur qui n'est pas en ligne, vous pouvez le faire ici. À sa prochaine connexion, il sera en sourdine.",
};
...
const npc_message: Record<NPC_MESSAGE, string> = {
  ...
  "npcMessages.findley.msg4":
    "Vous cherchez à attraper un Thon ? Ils ont une affection particulière pour le croquant alléchant du chou-fleur.",
  ...
  "npcMessages.findley.msg9":
    "Saviez-vous que le Mahi Mahi ne peut pas résister au croquant sucré du maïs ?",
  // Corale
...
const npcDialogues: Record<NpcDialogues, string> = {
  ...
  "npcDialogues.pumpkinPete.intro2":
    "Salut là, citrouille ! J'ai été occupé à guider les Bumpkins autour de la place ? As-tu eu ma commande ?",
  ...
  "npcDialogues.pumpkinPete.positiveDelivery5":
    "Oh, des graines de citrouille de joie ! Tu m'as apporté exactement ce dont j'avais besoin. La place te remercie pour ton aide !",
  ...
  "npcDialogues.pumpkinPete.noOrder1":
    "Eh bien, mon ami, il semble que je n'aie pas de commande active pour toi en ce moment. Mais ne crains rien ! Je suis toujours là pour t'offrir des conseils et un sourire amical de citrouille.",
...
const pageFounds: Record<PageFounds, string> = {
  ...
  "pageFounds.checkCodex":
    "Consultez le Codex pour en savoir plus à ce sujet !",
...
const quest: Record<Quest, string> = {
  "quest.mint.free": "Minter un accessoire gratuit",
};
...
const toolDescriptions: Record<ToolDescriptions, string> = {
  ...
  "description.gold.pickaxe": "Utilisé pour collecter des crimstones",
};
...
const world: Record<World, string> = {
  "world.intro.one":
    "Salut, voyageur ! Bienvenue sur la Place des Citrouilles.",
  "world.intro.two":
    "La place est le foyer d'un groupe diversifié de Bumpkins affamés et de Goblins qui ont besoin de votre aide !",
  "world.intro.three":

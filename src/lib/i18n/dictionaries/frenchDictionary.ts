...
const hayseedHankV2: Record<HayseedHankV2, string> = {
  ...
  "hayseedHankv2.dialog2":
    "Cependant, mes os ne sont plus ce qu'ils étaient. Si tu peux m'aider avec mes tâches quotidiennes, je te récompenserai avec des {{ticket}}s.",
...
const offer: Record<Offer, string> = {
  ...
  "offer.beginWithNFT":
    "Pour commencer, tu devras frapper un NFT de Ferme gratuit. Cela inclura :",

...
const generalTerms: Record<GeneralTerms, string> = {
  ...
  error: "Erreur",
  exotics: "Exotiques",
  "expand.land": "Étendre votre terre",
  expand: "Étendre",
  explore: "Explorer",
  farm: "Ferme",
  ...
  item: "Objet",
  land: "Terre",
  "land.id": "ID de la Terre :",
  "last.updated": "Dernière mise à jour",
  left: "Restant",
  "let'sDoThis": "Allons-y !",
  "lets.go": "C'est parti !",
  limit: "Limite",
  list: "Liste",
  ...
  off: "Éteindre",
  "offer.end": "L'offfre prend fin dans ",
  ok: "OK",
  on: "Allumer",
...
const boostEffectDescriptions: Record<BoostEffectDescriptions, string> = {
  "description.obie.boost": "25% de vitesse supplémentaire pour les aubergines",
  "description.purple.trail.boost": "+0,2 d'aubergine",
  "description.freya.fox.boost": "+0,5 de citrouille",
  "description.sir.goldensnout.boost": "+0,5 de cultures (zone d'effet)",
  "description.maximus.boost": "+1 d'aubergine",
  "description.basic.scarecrow.boost":
    "20% de vitesse supplémentaire pour les tournesols, les pommes de terre et les citrouilles",
  "description.scary.mike.boost":
    "+0,2 de rendement supplémentaire sur les carottes, les choux, les betteraves, les choux-fleurs et les panais",
  "description.laurie.chuckle.crow.boost":
    "+0,2 de rendement supplémentaire sur les aubergines, le maïs, les radis, le blé et le chou frisé",
  "description.bale.boost": "Les poules adjacentes produisent +0,2 d'œufs",
  "description.immortal.pear.boost": "+1 de récolte",
  "description.treasure.map.boost": "+20% de SFL sur le butin du trésor",
  "description.poppy.boost": "+0,1 de maïs",
  "description.kernaldo.boost": "+25% de vitesse de croissance du maïs",
  "description.grain.grinder.boost": "+20% d'XP de gâteau",
  "description.nana.boost": "+10% de vitesse de banane",
  "description.soil.krabby.boost": "+10% de vitesse de composteur",
  "description.skill.shrimpy.boost": "+20% d'XP de poisson",
  "description.iron.idol.boost": "+1 de fer",
  "description.emerald.turtle.boost": "+0,5 de minéraux en zone d'effet",
  "description.tin.turtle.boost": "+0,1 de pierres en zone d'effet",
  "description.heart.of.davy.jones.boost": "Creusez 20 fois de plus par jour",
  "description.Karkinos.boost": "+0,1 de chou",
  "description.mushroom.house.boost": "+0,2 de champignon sauvage",
  "description.boost.gilded.swordfish": "+0,1 d'or",
};

...
const generalTerms: Record<GeneralTerms, string> = {
  ...
  achievements: "成就",
  accept: "接受:",
  "accepting.terms": "接受條款中...",
  "amount.matic": "MATIC換算數額",
  deposit: "存入",
  add: "添加",
  addSFL: "添加 SFL",
  "add.liquidity": "添加流動性",
  ...
  deliver: "快遞",
  deliveries: "快遞",
  "deliveries.closed": "快遞已關閉",
  delivery: "快遞",
  details: "詳情：",
  donate: "捐贈",
  donating: "捐贈中",
  "drafting.noitem": "沒有物品可供上架",
  "drafting.select": "選擇要上架的東西",
  "drafting.trade.detail": "交易細節",
  dragMe: "拖我",
  earn: "贏取",
  "easter.eggs": "復活節彩蛋",
  egg: "蛋",
  empty: "空的",
  "enjoying.event": "喜歡這個活動嗎？",
  equip: "設備",
  error: "錯誤",
  exchange: "交易所",
  exotics: "魔法",
  ...
  "fish.caught": "捕獲的魚：",
  flowers: "花卉",
  "flowers.found": "已找到的花卉",
  foods: "食物",
  for: "換",
  "for.info.wearable": "而此裝飾的詳情",
  forbidden: "禁止入內",
  fruit: "水果",
  fruits: "水果",
  gift: "禮物",
  "go.home": "回家",
  "goblin.delivery":
    "哥布林將他們的快遞分存在寶藏庫裡。也可到此處{{opensea}查閱}",
  gotIt: "知道了",
  goto: "去了",
  "grant.wish": "許下新願望",
  guide: "指南",
  ...
  next: "繼續",
  "next.order": "下一張訂單",
  nextSkillPtLvl: "新技能點數等級：",
  no: "否",
  "no.delivery.avl": "沒有快遞訂單",
  "no.event": "沒有活動",
  "no.have.bumpkin": "你還沒有持有一個鄉巴佬",
  "no.limits.exceeded": "未超出上限",
  "no.mail": "你的信箱是空的",
  "no.obsessions": "沒有這個困擾",
  "no.thanks": "不用了謝謝",
  "ocean.fishing": "海釣",
  off: "關",
  "offer.end": "報價截止剩下",
  ...
  player: "玩家",
  "play.again": "再玩一次",
  "please.try.again": "請稍後再試",
  "please.wait": "請耐心等待",
  "pay.attention.feedback": "請留意回饋圖示：",
  print: "列印",
  "promo.code": "優惠碼",
  "providing.liquidity": "提供流動性",
  purchased: "已購買",
  purchasing: "購買中",
  rank: "排名",
  rare: "稀有",
  ...
  retry: "重試",
  reward: "獎勵",
  "reward.discovered": "獎勵揭曉",
  save: "存檔",
  saving: "存檔中",
  search: "搜尋",
  searching: "搜尋中",
  "seasonal.treasure": "季度珍品",
  seeds: "種子",
  selected: "已選取",
  "select.resource": "選取你的魚餌: ",
  sell: "賣出",
  "sell.all": "全部賣出",
  "sell.one": "賣一個",
  "sell.ten": "賣十個",
  "session.expire": "你的連線階段已過期",
  "session.expired": "連線階段過期！",
  settings: "設定",
  share: "分享",
  shopping: "購物",
  skillPts: "技能點數：",
  ...
  trading: "交易中",
  transfer: "轉移",
  "trash.collection": "資源回收", //或垃圾收集
  travel: "旅行",
  "traveller.ready": "嘿，旅行者！準備好探索了嗎？",
  "try.again": "再試一次",
  uhOh: "呃噢！",
  uncommon: "罕見",
  "unlock.land": "解鎖更多土地",
  ...
  viewAll: "查看全部",
  visit: "參觀",
  "visit.enter.land": "輸入土地ID以瀏覽提供的內容",
  "visit.friend": "拜訪朋友",
  "visit.land": "參觀土地",
  wallet: "錢包",
  warning: "警告",
  ...
  optional: "可選",
  "p2p.trading": "P2P 交易",
  "remaining.free.listings": "剩餘{{listingsRemaining}}個免費上架",
  "remaining.free.listing": "剩餘1個免費上架",
  "remaining.free.purchases": "剩餘{{purchasesRemaining}}次免費購買",
  "remaining.free.purchase": "剩餘1次免費購買",
  requirements: "要求",
  "goblin.deliveries": "哥布林快遞",
  vipAccess: "VIP權限",
  vip: "VIP",
};
...
const achievementTerms: Record<AchievementsTerms, string> = {
  "breadWinner.description": "獲得0.001SFL",
  "breadWinner.one": "好吧，好吧，夥計... 看來你需要一些SFL！",
  "breadWinner.two":
    "在Sunflower Land，囤積充足的SFL是鍛造工具、建築和稀有NFT的關鍵",
  "breadWinner.three": "最快賺取SFL的方式是種植並出售作物。",

  "sunSeeker.description": "收穫向日葵100次",
  "cabbageKing.description": "收穫甘藍菜200次",
  "jackOLantern.description": "收穫南瓜500次",
  "coolFlower.description": "收穫花椰菜100次",
  "farmHand.description": "收穫作物10,000次",
  "beetrootBeast.description": "收穫甜菜2,000次",
  "myLifeIsPotato.description": "收穫馬鈴薯5,000次",
  "rapidRadish.description": "收穫蘿蔔200次",
  "twentyTwentyVision.description": "收穫胡蘿蔔10,000次",
  "stapleCrop.description": "收穫小麥10,000次",
  "sunflowerSuperstar.description": "收穫向日葵100,000次",
  "bumpkinBillionaire.description": "賺取5,000 SFL",
  "patientParsnips.description": "收穫防風草5,000次",
  "cropChampion.description": "收穫1百萬次作物",

  "busyBumpkin.description": "達到第2級",
  "busyBumpkin.one":
    "好耶，我有理想抱負的朋友！想要解鎖新的作物、擴建、建築等等，你需要升級",
  "busyBumpkin.two": "前往Fire Pit，烹調一道美味的食譜，然後餵給你的鄉巴佬吃。",

  "kissTheCook.description": "烹調20頓餐點",
  "bakersDozen.description": "烘焙13個蛋糕",
  "brilliantBumpkin.description": "達到第20級",
  "chefDeCuisine.description": "烹調5,000頓餐點",

  "scarecrowMaestro.description": "鍛造一個稻草人並增強你的作物",
  "scarecrowMaestro.one":
    "哈囉，夥計！是時候讓你學習鍛造的技藝並提升你的農務能力了",
  "scarecrowMaestro.two":
    "前往Pumpkin Plaza，拜訪Blacksmith並製作一個稻草人吧！",

  "bigSpender.description": "花費10 SFL",
  "museum.description": "在你的土地上擺放10種不同的稀有物品",
  "highRoller.description": "花費7,500 SFL",
  "timbeerrr.description": "砍伐150棵樹",
  "craftmanship.description": "鍛造100個工具",
  "driller.description": "開採50塊石頭",
  "ironEyes.description": "開採50塊鐵礦",
  "elDorado.description": "開採50塊金礦",
  "timeToChop.description": "鍛造500斧頭",
  "canary.description": "開採1,000塊石頭",
  "somethingShiny.description": "開採500塊鐵礦",
  "bumpkinChainsawAmateur.description": "砍伐5,000棵樹",
  "goldFever.description": "開採500塊金礦",

  // Explorer
  "explorer.one":
    "讓我們砍倒這些樹木，收集木材並拓展島嶼。試試看那樣才是最好的方法吧。",
  "expansion.description": "將你的土地拓展新的土地。",

  // Well of Prosperity
  "wellOfProsperity.description": "建造一口井",
  "wellOfProsperity.one": "嗯，嗯，嗯，這裡有什麼呢？",
  "wellOfProsperity.two":
    "看來你的作物需要水分。要能種植更多作物，你首先必須建造一口井。",

  "contractor.description": "在你的土地上建造10棟建築",
  "fruitAficionado.description": "收穫50個水果",
  "fruitAficionado.one":
    "嘿，那位果農！水果可是大自然最甜美的禮物，它們為你的農場帶來了一陣味道的爆發。",
  "fruitAficionado.two":

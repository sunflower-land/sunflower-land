...
const generalTerms: Record<GeneralTerms, string> = {
  ...
  "free.trade": "免交易费", // meaning free of fee for actual practice reason
  fruit: "水果",
  fruits: "水果", // Basket
  "go.home": "回<农场>",
  "goblin.delivery": "哥布林将<送货>分成放在珠宝库里。查览也可到此处",
  gotIt: "知道了",
  goto: "去",
  "grant.wish": "许下新愿望",
  guide: "指南",
...
const achievementTerms: Record<AchievementsTerms, string> = {
  ...
  "deliveryDynamo.one": "好喂，可靠的农夫！ 到处的<乡包佬>都需要你帮忙<送货>。",
...
const basicTreasure: Record<BasicTreasure, string> = {
  ...
  // Translate
  "budBox.open": ENGLISH_TERMS["budBox.open"], // "Open",
  "budBox.opened": ENGLISH_TERMS["budBox.opened"], // "Opened",
  "budBox.title": ENGLISH_TERMS["budBox.title"], // "Bud box",
  "budBox.description": ENGLISH_TERMS["budBox.description"], // "Each day, a bud type can unlock farming rewards.",
  "raffle.title": ENGLISH_TERMS["raffle.title"], // "Goblin Raffle",
  "raffle.description": ENGLISH_TERMS["raffle.description"], // "Each month, you have a chance to win rewards. Winners will be announced on Discord.",
  "raffle.entries": ENGLISH_TERMS["raffle.entries"], // "entries",
  "raffle.noTicket": ENGLISH_TERMS["raffle.noTicket"], // "Missing Prize Ticket",
  "raffle.how": ENGLISH_TERMS["raffle.how"], // "You can collect Prize Tickets for free through special events and Bumpkin deliveries.",
  "raffle.enter": ENGLISH_TERMS["raffle.enter"], // "Enter",
};
...
const birdiePlaza: Record<BirdiePlaza, string> = {
  ...
  "birdieplaza.currentSeason": "现在正值",
  "birdieplaza.currentSeason.two": "季，而<乡巴佬>疯了似地追求",
  "birdieplaza.collectTickets": "去收集够",
  "birdieplaza.collectTickets.two":
    "来铸造稀罕<NFT>。我就是这样得来的这件稀罕<饰品>！",
  "birdieplaza.whatIsSeason": "什么是<时季>？",
  "birdieplaza.howToEarnTickets": "我怎样赚取",
  "birdieplaza.earnTicketsVariety": "赚取",
  "birdieplaza.earnTicketsVariety.two": "办法多多。",
  "birdieplaza.commonMethod": "通常办法来说，要赚取 ",
  "birdieplaza.commonMethod.two": "就是收集资源并交给<Plaza>的<乡巴佬>们。",
  "birdieplaza.choresAndRewards": "除此之外，想多赚",
  "birdieplaza.choresAndRewards.two": "可以给<Hank>做<日常农活>领取每日奖励！",
  "birdieplaza.gatherAndCraft": "收集够",
  "birdieplaza.gatherAndCraft.two": "你就能够像我这样<锻造>一些稀罕物品。",
  "birdieplaza.newSeasonIntro":
    "<Sunflower Land>每 3 个月会迎来一个新的<时季>。",
  "birdieplaza.seasonQuests":
    "这个<时季>有激动人心的任务和稀罕收藏品等你赚取。",
  "birdieplaza.craftItems": "要<锻造>这些物品，你得收集",
  "birdieplaza.craftItems.two": "并用它们到<超星商店>兑换或到<拍卖行>竞标。",
};
...
const boostDescriptions: Record<BoostDescriptions, string> = {
  ...
  "description.grain.grinder": "磨碎你的谷物，享受美味<蛋糕>，增加你获得的 XP",
  ...
  "description.tiki.totem": "<Tiki Totem>会在你每次砍树时额外增加 0.1 个<木头>",
...
const boostEffectDescriptions: Record<BoostEffectDescriptions, string> = {
  ...
  "description.apprentice.beaver.boost": "+20% <木头>； -50% <树木>恢复时间",
  ...
  "description.beehive.boost": "当<蜂箱>已满时，有 10% 几率获得 +0.2 <庄稼>",
...
const buildingDescriptions: Record<BuildingDescriptions, string> = {
  ...
  "description.turbo.composter": "<涡轮堆肥器>。定期生产高级<鱼饵>和<肥料>",
  ...
  "description.premium.composter": "<旗舰堆肥器>。定期生产专业<鱼饵>和<肥料>",
  "description.town.center": "<镇中心>。聚集到<Town Center>获取最新消息",
  "description.market": "<市场>。在农贸<Market>购买和出售",
  "description.fire.pit": "<火堆>。烤你的<向日葵>，喂食并升级你的<乡包佬>",
...
const bumpkinDelivery: Record<BumpkinDelivery, string> = {
  ...
  "bumpkin.delivery.proveYourself": "证明自己的价值。再<拓张>你的岛屿多",
  "bumpkin.delivery.more.time": "次。",
};
...
const bumpkinTrade: Record<BumpkinTrade, string> = {
  "bumpkinTrade.askPrice": "叫价",
  "bumpkinTrade.listingPurchased": "恭喜，你的挂单已被买下！",
  "bumpkinTrade.travelPlaza": "跑到<Plaza>上好让玩家们与你做<买卖>吧",
...
const buyFarmHand: Record<BuyFarmHand, string> = {
  ...
  "buyFarmHand.newFarmhandGreeting": "我是你的新<雇农>。我已经等不及要开干了！",
};
...
const chumDetails: Record<ChumDetails, string> = {
  ...
  "chumDetails.carrot": "最好搭配<Earthworm>来抓<Anchovy>！",
  ...
  "chumDetails.anchovy": "<Anchovy>，在海内狂徒面前总是神奇地诱人",
  "chumDetails.redSnapper": "海洋深处潜藏的奥秘",
  "chumDetails.tuna": "得长多大才吃得下一条<Tuna>？",
  "chumDetails.squid": "用<Ray>最爱的零食唤醒它！",
...
const confirmationTerms: Record<ConfirmationTerms, string> = {
  "confirmation.sellCrops": "你是否确定要",
};

const confirmSkill: Record<ConfirmSkill, string> = {
  "confirm.skillClaim": "你是否确定要领取<技能>？",
};
...
const conversations: Record<Conversations, string> = {
  ...
  "hank-intro.three": "我能教教你耕作基础，只要你肯帮我干点<日常农活>就好啦。",
  ...
  "pete.pumpkinPlaza.one":
    "当你<升级>时，你将解锁新的领域以供探索。 首先是<Pumpkin Plaza>……我的家！",
  ...
  "pete.intro.one":
    "好喂，这边，<乡巴佬>！ 欢迎来到<Sunflower Land>，一个富饶的农业天堂，这里一切皆有可能！",
  "pete.intro.two":
    "你建立的<岛屿>多么美丽啊！ 我是<Pumpkin Pete>，你的农民邻居。",
  "pete.intro.three":
    "<乡巴佬>们现在正在<Plaza>上庆祝节日，有丰厚的奖励和神奇的物品。",
  "pete.intro.four":
...
const cropFruitDescriptions: Record<CropFruitDescriptions, string> = {
  ...
  "description.kale": "<羽衣甘蓝>。<乡巴佬>能量食品！",

  // Fruits
  "description.blueberry": "<蓝莓>。哥布林的弱点。",
  "description.orange": "维生素 C 让你的乡巴佬保持健康",
  "description.apple": "非常适合自制苹果派",
  "description.banana": "哦香蕉！",

  // Exotic Crops
  "description.white.carrot": "一根浅色的胡萝卜，有浅色的根",
  "description.warty.goblin.pumpkin": "一个异想天开、长满疣的南瓜",
  "description.adirondack.potato": "坚固的马铃薯，阿迪朗达克风格！",
  "description.purple.cauliflower": "高贵的紫色花椰菜",
  "description.chiogga": "彩虹甜菜！",
  "description.golden.helios": "阳光亲吻的宏伟！",
  "description.black.magic": "一朵黑暗而神秘的花！",

  //Flower Seed
  "description.sunpetal.seed": "一粒 Sunpetal 种子",
  "description.bloom.seed": "一粒 Bloom 种子",
  "description.lily.seed": "一粒 Lily 种子",
};
...
const islandupgrade: Record<Islandupgrade, string> = {
  ...
  "islandupgrade.notReadyExpandMore": "要升级你的岛屿，你需要再扩张",
  "islandupgrade.notReadyExpandMore.two": "倍。 在此之前，你还没有准备好升级。",

...
const foodDescriptions: Record<FoodDescriptions, string> = {
  ...
  "description.friedCalamari": "鱿鱼圈香脆，纵情享美味",
  "description.friedTofu": "金边炸豆腐，精心香出炉。",
  "description.grapeJuice": "可口酸甜，现榨新鲜。",
  "description.oceansOlive": "怡人海滨菜，Sunflorian 名菜。",
  "description.quickJuice": "充能一瞬间，Goblin 精选。",
  "description.riceBun": "软糯饭团人人爱。",
  "description.slowJuice": "营养果汁，Bumpkin 手艺。",
  "description.steamedRedRice": "完美蒸红米，Bumpkin 常欢喜。",
  "description.sushiRoll": "美味寿司卷，匠人精手艺。",
  "description.theLot": "美味杂果汁，解渴又营养。",
  "description.tofuScramble": "地道炒豆腐，美味高蛋白。",
};

const gameDescriptions: Record<GameDescriptions, string> = {
  // Quest Items
  "description.goblin.key": "Goblin 钥匙",
  "description.sunflower.key": "Sunflower 钥匙",
  ...
  // Coupons
  "description.community.coin": "（待完善）可以用于兑换奖励的宝贵硬币",
  "description.bud.seedling": "（往期）用于兑换免费蕾芽 Nft 的幼苗",
  "description.gold.pass": "（往期）允许持有者锻造稀有 NFT、交易、提现与享受额外内容的独家票券。",
  "description.rapid.growth": "（往期）施加给庄稼让生长速度翻倍",
  "description.bud.ticket": "（往期）在 Sunflower Land 蕾芽 NFT 商店铸造蕾芽的保底票。",
  "description.potion.ticket": "药水屋发放的奖励。用这个到 Garth 那儿买换物品。",
  "description.trading.ticket": "（往期）买卖免手续费！呜呼！",
  "description.block.buck": "Sunflower Land 上珍贵的代币！",
  "description.beta.pass": "（独家）抢先体验测试功能。",
  "description.war.bond": "（往期）真勇士的标志",
  "description.allegiance": "（往期）忠诚的证明",
  "description.jack.o.lantern": "（往期）万圣节特别活动物品",
  "description.golden.crop": "（往期）闪着金光的庄稼",
  "description.red.envelope": "（往期）哇，你真幸运！",
  "description.love.letter": "（往期）传达爱意",
  "description.solar.flare.ticket":
    "（往期）日光耀斑时季使用的票券。",
  "description.dawn.breaker.ticket":
    "（往期）破晓来使时季使用的票券。",
  "description.crow.feather": "（往期）女巫之夜时季使用的票券。",
  "description.mermaid.scale": "（往期）追捕海怪时季使用的票券。",
  "description.sunflower.supporter":
    "游戏真正支持者的证章！",
  "description.arcade.coin": "从小游戏与冒险中赚得的代币。可用于兑换奖赏。",
  "description.farmhand.coupon": "挑选兑换雇农的票券。",
  "description.farmhand": "你农场上雇养的乡包佬",
  "description.tulip.bulb": "（往期）春暖花开时季使用的票券。",
  "description.treasure.key": "到广场上开箱解锁奖赏",
  "description.rare.key": "到沙滩上开箱解锁奖赏",
  "description.luxury.key": "到广场上靠近林地处开箱解锁奖赏",
  "description.prizeTicket": "抽奖奖券。您可以用它投注参与每月 Goblin 抽奖。",
  "description.babyPanda": "Gas Hero 活动送的可爱熊猫。为当期 3 月份期间的新手提供翻倍经验。",
  "description.baozi": "农历新年活动送的美味小吃。",
  ...
  "description.scroll": "（往期）帮派冲突时季使用的票券。",
  "description.amberFossil": "法老秘宝时季使用的票券。",

  // Emblem
  "description.bumpkin.emblem": "向 Bumpkin 展示你的忠诚",
  "description.goblin.emblem": "向 Goblin 展示你的忠诚",
  "description.sunflorian.emblem":
    "向 Sunflorian 展示你的忠诚",
  "description.nightshade.emblem":
    "向 Nightshade 展示你的忠诚",
  "description.faction.mark": "到帮派商店使用它们",
};
...
export const desertTerms: Record<DesertKeys, string> = {
  ...
  "desert.hud.digsLeft": "{{digsLeft}} 次剩余挖掘次数",
  "desert.hud.noDigsLeft": ENGLISH_TERMS["desert.hud.noDigsLeft"],
  "desert.hud.newSite": "新挖宝场！",

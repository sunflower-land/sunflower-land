...
const beehive: Record<Beehive, string> = {
  "beehive.honey": "Mel:",
  "beehive.harvestHoney": "Colher mel",
};
...
const buyFarmHand: Record<BuyFarmHand, string> = {
  ...
  "buyFarmHand.newFarmhandGreeting":
    "Sou seu novo ajudante de fazenda. Mal posso esperar para começar a trabalhar!",
};
...
const pirateQuest: Record<PirateQuest, string> = {
  ...
  "piratequest.welcome":
    "Bem-vindo aos altos mares da aventura, onde serás testado como um verdadeiro pirata. Embarque numa jornada para encontrar o saque mais rico e tornar-se o maior pirata a navegar pelas ondas do oceano.",
  "piratequest.finestPirate":
    "Ahoy, tu és o mais fino pirata dos sete mares com teu tesouro!!",
  "piratequest.noMoreGifts":
    "Não tenho mais presentes para ti. Não te esqueças de usar os teus novos itens!",
};
...
const offer: Record<Offer, string> = {
  ...
  "offer.beginWithNFT": "Para começar, você precisará cunhar um",
...
const piratechest: Record<PirateChest, string> = {
  "piratechest.greeting":
    "Ahoy companheiro! Navegue e volte mais tarde para um baú cheio de recompensas de pirataria!",
  "piratechest.refreshesIn": "Atualização do baú em:",
  "piratechest.warning":
    "Ahoy lá! Este baú está cheio de tesouros dignos de um rei pirata, mas cuidado, apenas aqueles com uma pele de pirata podem abri-lo e reivindicar o tesouro dentro!",
};
...
const seasonTerms: Record<SeasonTerms, string> = {
  ...
  "season.mintSeasonalBanner": "Cunhe sua Bandeira Sazonal exclusiva:",
};
...
const somethingWentWrong: Record<SomethingWentWrong, string> = {
  ...
  "somethingWentWrong.jumpingOver": "ou pulando para o nosso",
  "somethingWentWrong.askingCommunity": "e perguntando à nossa comunidade.",
};

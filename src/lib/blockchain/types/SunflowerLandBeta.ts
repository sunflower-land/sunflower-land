...
export interface SunflowerLandBeta extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): SunflowerLandBeta;
  clone(): SunflowerLandBeta;
  methods: {
    createFarm(
    ...
    setMintFee(_fee: number | string | BN): NonPayableTransactionObject<void>;

    transferOwnership(newOwner: string): NonPayableTransactionObject<void>;

    transferSigner(_signer: string): NonPayableTransactionObject<void>;

    transferTeam(_team: string): NonPayableTransactionObject<void>;

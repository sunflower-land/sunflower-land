      ...
      {onToggleFavorite && (
        <>
          <button
            ...
            title={favoriteLabel}
            className="absolute bottom-4 right-4 h-8 w-8 cursor-pointer border-0 bg-transparent p-0 hover:img-highlight"
            onClick={(event) => {
          ...
          {favoriteFeedback && (
            <Label
              ...
              className="absolute bottom-14 -right-6 z-[1] pointer-events-none whitespace-nowrap"
            >

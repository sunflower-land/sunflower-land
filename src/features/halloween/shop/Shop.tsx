...
import shop from "assets/events/halloween/assets/buildings/shop_building.png";
import plant from "assets/icons/plant.png";

import { GRID_WIDTH_PX } from "features/game/lib/constants";
import { Action } from "components/ui/Action";

import { ShopItems } from "src/features/farming/shop/ShopItems";
import { Section } from "lib/utils/hooks/useScrollIntoView";
import { shopAudio } from "lib/utils/sfx";

export const HalloweenShop: React.FC = () => {

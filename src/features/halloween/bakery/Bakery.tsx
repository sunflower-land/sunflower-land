...
import bakery from "assets/events/halloween/assets/buildings/bakery_building.png";
import smoke from "assets/buildings/bakery_smoke.gif";
import soup from "assets/icons/goblin_head.png";

import { Crafting } from "src/features/farming/bakery/components/Crafting";
import { Action } from "components/ui/Action";
import { GRID_WIDTH_PX } from "features/game/lib/constants";
import { bakeryAudio } from "lib/utils/sfx";

export const HalloweenBakery: React.FC = () => {

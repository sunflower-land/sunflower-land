...
import house from "assets/events/halloween/assets/buildings/house.png";
...
import { SkillUpgrade } from "src/features/farming/house/components/SkillUpgrade";
import { SkillTree } from "src/features/farming/house/components/SkillTree";
...
export const HalloweenHouse: React.FC<Props> = ({
  state,
  isFarming,
  playerCanLevelUp,
}) => {

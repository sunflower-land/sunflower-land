...
import goblinFarmer from "assets/events/halloween/assets/npcs/goblin_farmer.gif";
import cowbell from "assets/skills/barn_manager.png";
import { barnAudio } from "lib/utils/sfx";

import { GRID_WIDTH_PX } from "features/game/lib/constants";
import { Action } from "components/ui/Action";
import { ItemsModal } from "src/features/goblins/farmer/ItemsModal";

export const HalloweenFarmer: React.FC = () => {

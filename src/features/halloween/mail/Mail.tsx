...
import { Inbox } from "features/farming/mail/components/Inbox";
import { GRID_WIDTH_PX } from "features/game/lib/constants";

import { Message } from "features/farming/mail/types/message";
import {
  cleanupCache,
  getInbox,
  getReadMessages,
  updateCache,
} from "features/farming/mail/lib/mail";

import baldMan from "assets/events/halloween/assets/npcs/bald_man.gif";
import alerted from "assets/icons/expression_alerted.png";

export const HalloweenMail: React.FC = () => {

...
//events begger
import begger from "assets/events/halloween/assets/npcs/begger.gif";
import richBegger from "assets/events/halloween/assets/npcs/rich_begger.gif";
...
export const HalloweenTeamDonation: React.FC = () => {

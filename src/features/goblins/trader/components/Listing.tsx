      ...
      <div className="w-full">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-xxs sm:text-xs whitespace-nowrap pl-2">{`${
              sfl + fee
            } SFL`}</span>
          </div>
        </div>
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <img src={token} className="w-5" />
            <span className="text-xxs sm:text-xs whitespace-nowrap pl-2">{`${sfl} SFL`}</span>
          </div>
        </div>
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-xxs sm:text-xs whitespace-nowrap pl-2">{`${fee} SFL`}</span>
          </div>
        </div>
      </div>
    </div>

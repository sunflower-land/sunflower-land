...
import { eventMachine, MachineInterpreter } from "../eventMachine";
...
export const EventModal: React.FC<Props> = () => {
  ...
  const [machine, send] = useMachine(eventMachine as any) as any;
    ...
    <Panel className="relative">
      <div className="flex">
        ...
        <div className="flex-1 p-2 flex flex-col items-center">
          ...
          <img src={wizard} alt="wishing well" className="w-full" />

...
> = {
  gathering: {
    ...
    description: `Gathering Resources: To thrive in Sunflower Land, mastering the art of resource gathering is essential. Start by equipping the appropriate tools to collect different resources. Use the trusty Axe to chop down trees and acquire wood. With the Wood Pickaxe, you can mine stone from rocks, while the Stone Pickaxe lets you extract iron from its rocky encasements. For the ultimate haul, wield the Iron Pickaxe to mine precious gold from sturdy golden rocks. Remember, each tool has a limited number of uses, so plan your resource collection wisely.

      Expanding Your Land: Expanding your land opens up new horizons in Sunflower Land. As you progress and gather sufficient resources, you'll unlock the ability to expand your territory. Land expansions reveal a treasure trove of resources, including fertile soil for planting crops, majestic trees, valuable stone deposits, precious iron veins, shimmering gold deposits, delightful fruit patches, and formidable boulders (to be released in future updates). Strategically navigate the expansion process and uncover these resources to fuel the growth of your farming empire. Keep in mind that later expansions operate on a land pack system, granting random land pieces from specific packs, ensuring a fair and exciting experience for all players.
  ...
  crops: {
    ...
    description: `Crops and Earning SFL:
...
Remember, as you expand your land and progress in the game, more crops will become available, offering greater opportunities for earning SFL and exploring the vast potential of Sunflower Land's farming economy. So get your hands dirty, plant those seeds, and watch your crops flourish as you harvest your way to success!`,
  ...
  cooking: {
    ...
    description: `Cooking in Sunflower Land is a vital aspect of the game that allows you to nourish your Bumpkin and help them gain valuable experience points (XP). By utilizing the crops you've harvested, you can prepare delicious food at different buildings dedicated to cooking.

...
const WALKABLE_RECTANGLES: TiledRectangle[] = [
  {
    height: 152,
    id: 417,
    name: "",
...
export class BeachScene extends BaseScene {
  ...
  public setUpWalkableRectangles = () => {
  ...
  createObjectLayer() {
    const objectLayer: Phaser.Tilemaps.ObjectLayer = {
      name: "NavMesh",
      objects: [],
      opacity: 1,
      properties: {},
    ...
    WALKABLE_RECTANGLES.forEach((rect: TiledRectangle) => {

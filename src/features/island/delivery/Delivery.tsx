...
export const Delivery: React.FC = () => {
  ...
  if (delivery.orders.length === 0) {
    return <p>No more orders</p>;
  }

  if (!previewOrder) {
    previewOrder = delivery.orders[0];
  }
        ...
        title={
          <>
            ...
            >
              ...
              <img
                src={chest}
                className="absolute cursor-pointer h-8 shadow-lg animate-pulsate"
                style={{
                  right: 0,
                  top: "-4px",
                }}
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "12px" }}
              >{`${secondsToString(
                (previewOrder.expiresAt - Date.now()) / 1000,
                {
                  length: "medium",
                }
              )} left`}</span>

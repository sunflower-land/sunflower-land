...
// origin/main alongside its sibling LegacySkills / LegacySkillPathDetails.
// Delete this file when the EDIT_SKILLSET flag is removed.
import fruits from "assets/fruit/fruits.png";
import Decimal from "decimal.js-light";
import { capitalize } from "lib/utils/capitalize";
export const LEGACY_SKILL_TREE_ICONS: Record<BumpkinRevampSkillTree, string> = {
            ...
            <div key={islandType} className="flex flex-col items-stretch">
              ...
              <div className="grid grid-cols-2 gap-1">
                {categories.map((category) => {
                  ...
                  const icon = LEGACY_SKILL_TREE_ICONS[skills[0].tree];

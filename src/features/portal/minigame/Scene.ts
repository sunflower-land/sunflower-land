...
export class Scene extends BaseScene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      "giant_skeleton_idle",
      "public/world/minigame/skeleton_hurt.webp",
      {
        frameWidth: 23,
        frameHeight: 26,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/skeleton_attack.webp",
      {
        frameWidth: 23,
        frameHeight: 24,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/carrot_splat.webp",
      {
        frameWidth: 20,
        frameHeight: 20,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/tomato_splat.webp",
      {
        frameWidth: 18,
        frameHeight: 16,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/cabbage_splat.webp",
      {
        frameWidth: 27,
        frameHeight: 19,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/potato_splat.webp",
      {
        frameWidth: 26,
        frameHeight: 26,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/tomato_splatter.webp",
      {
        frameWidth: 17,
        frameHeight: 32,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/tomato_screenSplat.webp",
      {
        frameWidth: 160,
        frameHeight: 160,
      },
    ...
    this.load.spritesheet(
      ...
      "public/world/minigame/tomato_rolling.webp",
      {
        frameWidth: 160,
        frameHeight: 160,
      },
    ...
    this.load.image(
      ...
      "public/world/minigame/Wooden_Barrel.webp",
    );
    this.load.image(
      "sniper_skeleton_carrot",
      "public/world/minigame/carrot.png",
    );
    this.load.image(
      "sniper_skeleton_tomato",
      "public/world/minigame/tomato.webp",
    );
    this.load.image(
      "sniper_skeleton_cabbage",
      "public/world/minigame/cabbage.png",
    );
    this.load.image(
      "sniper_skeleton_potato",
      "public/world/minigame/potato.png",
    );

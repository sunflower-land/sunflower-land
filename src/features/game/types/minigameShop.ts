...
export const HALLOWEEN_STORE: Record<HalloweenShopItemName, EventShopItem> = {
  ...
  "Witch's Cauldron": {
    cost: { sfl: 0, items: { "Halloween Token 2025": 400 } },
    max: 1,
    type: "collectible",
  ...
  "Haunted House": {
    cost: { sfl: 0, items: { "Halloween Token 2025": 1000 } },
    max: 1,
    type: "collectible",
    name: "Haunted House",
  },
  ...
  "Sweet Devil Horns": {
    cost: { sfl: 0, items: { "Halloween Token 2025": 350 } },
    max: 1,
    type: "wearable",
  ...
  "Research Uniform": {
    cost: { sfl: 0, items: { "Halloween Token 2025": 700 } },
    max: 1,
    type: "wearable",

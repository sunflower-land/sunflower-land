...
export const CHAPTER_BANNERS: Record<ChapterBanner, ChapterName> = {
  ...
  "Lost Ascension Banner": "Lost Ascension",
};
...
> = {
  ...
  "Lost Ascension": "Lost Ascension Raffle Ticket",
};
...
export const CHAPTER_MARVEL_FISH: Record<ChapterName, ChapterFish> = {
  ...
  // TODO(Lost Ascension): confirm which of the 3 chapter fish is the marvel
  "Lost Ascension": "Crocodile",
};
...
export const CHAPTER_BANNER_IMAGES: Record<ChapterBanner, string> = {
  ...
  "Lost Ascension Banner": lostAscensionBanner,
};

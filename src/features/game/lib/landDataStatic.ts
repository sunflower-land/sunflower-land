...
export const STATIC_OFFLINE_FARM: GameState = {
  ...
  inventory: {
    ...
    "Easter Ticket 2025": new Decimal(10),
    "Carrot House": new Decimal(1),
    "White Bunny Lantern": new Decimal(1),
    "Orange Bunny Lantern": new Decimal(1),
    "White Tunnel Bunny": new Decimal(1),
    "Orange Tunnel Bunny": new Decimal(1),
    "Easter Token 2025": new Decimal(5000),
    "Easter Basket": new Decimal(1),

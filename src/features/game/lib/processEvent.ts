...
export const maxItems: Inventory = {
  ...
  // Seed limits + buffer
  "Sunflower Seed": new Decimal(1750),
  "Potato Seed": new Decimal(900),
  "Pumpkin Seed": new Decimal(700),
  "Carrot Seed": new Decimal(450),
  "Cabbage Seed": new Decimal(450),
  "Soybean Seed": new Decimal(450),
  "Beetroot Seed": new Decimal(400),
  "Cauliflower Seed": new Decimal(400),
  "Parsnip Seed": new Decimal(300),
  "Eggplant Seed": new Decimal(250),
  "Corn Seed": new Decimal(250),
  "Radish Seed": new Decimal(200),
  "Wheat Seed": new Decimal(200),
  "Kale Seed": new Decimal(200),

  ...
  return (
    ...
    >
      ...
      <Button
        onClick={() =>
          window.open(
            "https://app.merkl.xyz/opportunities/base/CLAMM/0xafE30319a948F322585faFC1Cab1671A47eB3786/leaderboard?campaignId=0x89dd96c10c739800b241a2e77fc44b5c0766766d437501dd9dcfb0e4314e6de3&page=1",
            "_blank",
          )
        }
      >

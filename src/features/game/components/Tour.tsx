...
// Check local storage to see if tour completed
// if not show tour
...
const steps: ReactourStep[] = [
  ...
  },
  {
    ...
    content: () => (
      <div>
        ...
        Once you save you can close the browser and come back later to harvest
        your fields.
        <br />
        <div id="tour-button">
          <Button onClick={() => service.send("NEXT")}>Next</Button>
  ...
  },
  {
    ...
    content: () => (
      <div>
        You can buy different types of seeds here. Some are more expensive but
...
export const Tour: React.FC = () => {
  ...
  const step =
    STEP_MACHINE[(machineState.value as any).onboarding as OnboardingStates] ||
    0;

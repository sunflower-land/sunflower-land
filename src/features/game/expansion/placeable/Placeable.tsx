...
import { RESOURCE_COMPONENTS } from "features/island/resources/Resource";
import { getGameGrid } from "./lib/makeGrid";
import { BUILDING_COMPONENTS } from "features/island/buildings/components/building/BuildingComponents";
      ...
      <div className="fixed left-1/2 top-1/2" style={{ zIndex: 100 }}>
        ...
        >
          ...
          >
            ...
            >
              <Collectible coordinates={coordinates} grid={grid} />
            </div>
          </div>
        </Draggable>
      </div>

...
describe("getCropTime", () => {
  ...
  it("applies a 50% speed boost with Expert Composter placed, plot is within AOE while composting", () => {
    const sunflowerHarvestSeconds = CROPS()["Sunflower"].harvestSeconds;
    ...
    expect(time).toEqual(sunflowerHarvestSeconds * 0.5);
  });

  it("does not apply boost with Expert Composter if not composting", () => {
    const beetrootHarvestSeconds = CROPS()["Beetroot"].harvestSeconds;
  ...
  it("does not apply boost with Expert Composter placed, composting, but plot is outside AOE", () => {
    const sunflowerHarvestSeconds = CROPS()["Sunflower"].harvestSeconds;
  ...
  it("does not apply boost with Expert Composter placed, if it was moved within 10min", () => {
    const sunflowerHarvestSeconds = CROPS()["Sunflower"].harvestSeconds;

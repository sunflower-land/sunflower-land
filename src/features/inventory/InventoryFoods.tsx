...
import { Craftable, CraftableName, Food, FOODS } from '../game/types/craftables';
...
export const InventoryFoods: React.FC<Props> = ({}) => {
  ...
  const foods = Object.keys(FOODS) as InventoryItemName[];
  
  const VALID_Foods: InventoryItemName[] = foods;

  function isFood(crop: InventoryItemName): crop is Food {
    return VALID_Foods.includes(crop);
  }

...
| In-world micro-UI (TimerPopover, ProgressBar, floating `+N`, corner status icons)                                                                | **Stays React**, repositioned     | Rendered in a DOM overlay above the canvas, anchored to world positions via the anchor bridge (see ARCHITECTURE.md).                                       |

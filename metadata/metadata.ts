...
export const OPEN_SEA_WEARABLES: Record<BumpkinItem, Metadata> = {
  ...
  "Crab Hat": {
    description:
      "A cute, living crab perched atop your head, adding charm and a little extra personality. This friendly companion helps you catch more treasures from fishing with ease",
    decimals: 0,
    attributes: [
      { trait_type: "Boost", value: "Other" },
      {
